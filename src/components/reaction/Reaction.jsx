      ...
      <div className="periodic-table">
              ...
              backgroundColor: !selectedElement
                ...
                : selectedElement?.name === element.name ||
                  (selectedElement?.connection &&
                    selectedElement?.connection.includes(element.name))
                ? element.color
                : "lightgray",
            }}
            className={`element element-${element.number} ${
              selectedElement?.name === element.name ? "selectedItem" : ""
            }`}
        ...
        >
          <div className="theGif">
            <span>
              {" "}
              Press on an element to view its reactivity with other elements. If
              an element is grey, that means it does not react with the element
              selected.{" "}
            </span>
